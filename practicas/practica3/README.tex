...
\begin{enumerate}
    ...
    \item Justificación del patrón

    Utilizamos el patrón \textit{Abstract Factory} porque nos permitió crear 
    una fábrica para cada componente de los autos: llantas, motor, carrocería, 
    blindaje y armas. Además, cada fábrica se encarga de fabricar cada 
    producto del mismo tipo pero con características distintas entre ellos. 
