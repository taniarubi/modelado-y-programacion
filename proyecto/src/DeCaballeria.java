...
public class DeCaballeria implements Soldado {
    ...
    public void atacar(Enemigo enemigo) {
        if(this.distancia == 0 && this.puntos > 0 && enemigo.getPuntos() >= 0) {
            System.out.println(this.nombre + " ataca al enemigo con su mosquete!");
    ...
    @Override
    public void mover() {
        if((this.distancia - 15) > 0) {
            this.distancia -= 15;
            System.out.println(this.nombre + " se ha movido en su caballo!");
